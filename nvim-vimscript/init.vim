...
"open NERDTree automaticaly on nvim boot
autocmd VimEnter * NERDTree | if argc() > 0 || exists("s:std_in") | wincmd p | endif
"NERDTree close when close file
...
inoremap <silent> <C-x> <ESC>:x!<CR>i
":set scrolloff=5
